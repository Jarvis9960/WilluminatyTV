    ...
    <Fragment>
      <Container>
        ...
        <div className="tab-content">
          <div className="WilluminatyTV-content-details content-details trending-info g-border iq-rtl-direction">
            <Tab.Container defaultActiveKey="first">
              ...
              <Tab.Content className="tab-content">
                ...
                <Tab.Pane
                  ...
                  data-options="infinite_scroll"
                >
                  <div id="additional-info" className="WilluminatyTV-reviews">
                    <div className="description-content">
                ...
                >
                  <div
                    id="reviews"
                    className="WilluminatyTV-reviews"
